...
public class Player extends Thread {
    char sign; //oznaczenie gracza np. a
    int id; //id gracza (wartość od 0)
    int positionX; //pozycja X gracza (wartość od 0)
    int positionY; //pozycja Y gracza (wartość od 0)
    boolean direction; //kierunek gracza false - idzie do góry, true - idzie w dół
